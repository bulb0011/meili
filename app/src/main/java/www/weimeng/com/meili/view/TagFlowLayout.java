...
public class TagFlowLayout extends FlowLayout_ implements TagAdapter.OnDataChangedListener{
    ...
    {
        boolean onTagClick(View view, int position, FlowLayout_ parent);
    }
...
//            lp.rightMargin = clp.rightMargin;
            ...
            {
                MarginLayoutParams lp = new MarginLayoutParams(LayoutParams.WRAP_CONTENT, -2);
